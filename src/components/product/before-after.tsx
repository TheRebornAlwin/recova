...
const beforeItems = [
  "Waking up with a stiff, aching neck every morning",
  "Tension building up throughout your workday",
  "Spending $60+ per session on massages that only last a day",
  "Relying on painkillers just to get through the afternoon",
  "Missing out on activities because your neck is too sore",
];

const afterItems = [
  "Waking up feeling loose and ready for the day",
  "Getting through work without the pain creeping in",
  "One-time investment that you can use every single day",
  "Natural, drug-free relief whenever you need it",
  "Back to doing the things you actually enjoy",
];
      ...
      <div className="max-w-5xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.2em] uppercase text-teal mb-3">The Transformation</p>
            <h2 className="text-3xl md:text-4xl font-bold text-navy tracking-tight">
              Life Before vs After the NeckRelieve Pulse
            </h2>
          </div>
        </ScrollReveal>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <ScrollReveal delay={0.1} className="min-w-0">
            <div className="p-8 rounded-2xl bg-gray-50 border border-gray-200 h-full">
              <div className="flex items-center gap-3 mb-6 justify-center md:justify-start">
                ...
                <h3 className="text-xl font-bold text-gray-500">Without It</h3>
              </div>
          ...
          <ScrollReveal delay={0.2} className="min-w-0">
            <div className="p-8 rounded-2xl bg-teal/5 border-2 border-teal/20 h-full shadow-sm">
              <div className="flex items-center gap-3 mb-6 justify-center md:justify-start">
                <div className="w-10 h-10 rounded-full bg-teal/10 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-teal"><polyline points="20 6 9 17 4 12"/></svg>
                </div>
                <h3 className="text-xl font-bold text-navy">With NeckRelieve Pulse</h3>
              </div>
              <div className="space-y-3">
