...
const bonuses = [
  {
    label: "4 Extra Gel Pads Included",
    originalPrice: "$12.99",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" className="text-teal">
  ...
  {
    label: "16 Adjustable Intensity Levels",
    originalPrice: "$9.99",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" className="text-teal">
  ...
  {
    label: "5 Professional Massage Modes",
    originalPrice: "$14.99",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" className="text-teal">
