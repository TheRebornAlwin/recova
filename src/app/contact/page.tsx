        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-navy tracking-tight mb-4">
              Get in <TextGradient variant="teal">touch</TextGradient>
            </h1>
          ...
          {contactInfo.map((info, i) => (
            <ScrollReveal key={i} delay={i * 0.1}>
              <GlassmorphismCard className="text-center">
                ...
                <p className="text-sm text-slate">{info.detail}</p>
              </GlassmorphismCard>
            </ScrollReveal>
          ))}
        </div>
          ...
          <GlassmorphismCard className="max-w-2xl mx-auto">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-4 py-3 rounded-xl border border-light-gray bg-white focus:border-teal focus:outline-none transition-colors text-sm"
              ...
              <div>
                ...
                <textarea
                  rows={5}
                  className="w-full px-4 py-3 rounded-xl border border-light-gray bg-white focus:border-teal focus:outline-none transition-colors text-sm resize-none"
